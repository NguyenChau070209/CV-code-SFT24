...
def run(model: str, max_results: int, score_threshold: float, 
    ...
    while True:
        ...
        if detection_result_list:
            ...
            # Lấy tọa độ, chiều cao và chiều rộng của hộp detect lửa
            for detection in detection_result_list[0].detections:
                ...
                width = bbox.width
                height = bbox.height
                print(f"Lửa được phát hiện! Tọa độ: ({x_min}, {y_min}), ({x_max}, {y_max}), "
                      f"Chiều rộng: {width}, Chiều cao: {height}")

            print("Lửa được phát hiện! Dừng servo và làm sáng đèn LED.")
